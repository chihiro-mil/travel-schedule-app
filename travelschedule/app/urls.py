...
# 持ち物リストのCBVをインポート
from .views import PackingItemView, CreateView, UpdateView
...
urlpatterns = [
    ...
    path('schedule/<int:schedule_id>/packing_item/add/', CreateView.as_view(), name='packing_item_create_or_edit'),
